...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { description: @library.description, file_upload: @library.file_upload, tags: @library.tags, title: @library.title } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { description: @library.description, file_upload: @library.file_upload, tags: @library.tags, title: @library.title } }
